...
<img alt="empty"  src="https://res.cloudinary.com/did6jp3bj/image/upload/v1668709233/hire-me-logoSvg_nwibby.svg"></img>
</div>
        ...
        <div className="usersCardsDiv3">
          ...
          {!allUsers && (
            <div className="empety">
              <img alt="empty"  src="https://res.cloudinary.com/dfpuepvtg/image/upload/v1668974149/no_kxgfhk.png" />
            ...
            allUsers.map((elem, index) => {
              return (
                <div id={elem.id} key={index} className="userCard3">
                  <img  alt="empty"  className="userImageCard3" src={elem.userimage}></img>
                  <h2
